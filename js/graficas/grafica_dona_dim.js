(async function () {
    ...
    setTimeout(() => {
        ...
        objeto_resp.forEach(datos_preguntas => {//recorremos DIMENSIONES
            ...
            const objeto = {
                Tema: datos_preguntas.dimension,
                Valor: datos_preguntas.nivel_2,
            }
        ...
        // datos = [
        //     { Tema: 'Ambiental', Valor: '0.10069108308662117' },
        //     { Tema: 'Social', Valor: '0.4076903848429238' }
        // ]
        // console.log(datos)
        ...
        graficar(objeto_dimensiones)//llamamos a la funcion para graficar

        function graficar(datos) {
            d3.select('#chart_dona_dim')
                .datum(datos) // bind data to the div
                .call(donut); // draw chart_dona_dim in div
        }
